...
def process_jpgs(args):
    ...
    if os.path.isfile(args.image_path):
        ...
        output_directory = os.path.join(args.image_path, "processed/")
    ...
    count = 0
    # Go through camera data and process frames per second
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Video to monodepth2')
    ...
    parser.add_argument("--fps", dest='fps', help='How often do you want to grab images', type=int)
